...
**
** Copyright (C) 2024 Lumito (LumitoLuma).
** Contact: https://www.lumito.net/support/
**
        ...
        const QHash<QString, QByteArray> &qmakeValueHash, const QString &type)
{
    ...
    replaceHash.insert(QByteArray("qt_docspath=%1").replace("%1", oldValue),
        QByteArray("qt_docspath=%1/doc").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert(QByteArray("qt_hdrspath=%1").replace("%1", oldValue),
        QByteArray("qt_hdrspath=%1/include").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert(QByteArray("qt_libspath=%1").replace("%1", oldValue),
        QByteArray("qt_libspath=%1/lib").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    if (type == QLatin1String("windows")) {
        replaceHash.insert(QByteArray("qt_lbexpath=%1").replace("%1", oldValue),
                           QByteArray("qt_lbexpath=%1/bin").replace("%1/",
                                                                    QByteArray(newQtPath).append(nativeSeperator)));
    } else {
        replaceHash.insert(QByteArray("qt_lbexpath=%1").replace("%1", oldValue),
    ...
    replaceHash.insert(QByteArray("qt_binspath=%1").replace("%1", oldValue),
        QByteArray("qt_binspath=%1/bin").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert(QByteArray("qt_plugpath=%1").replace("%1", oldValue),
        QByteArray("qt_plugpath=%1/plugins").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert(QByteArray("qt_impspath=%1").replace("%1", oldValue),
        QByteArray("qt_impspath=%1/imports").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));

    oldValue = qmakeValueHash.value(QLatin1String("QT_INSTALL_QML"));
    replaceHash.insert(QByteArray("qt_qml2path=%1").replace("%1", oldValue),
        QByteArray("qt_qml2path=%1/qml").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert( QByteArray("qt_datapath=%1").replace("%1", oldValue),
        QByteArray("qt_datapath=%1/").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert( QByteArray("qt_trnspath=%1").replace("%1", oldValue),
        QByteArray("qt_trnspath=%1/translations").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert( QByteArray("qt_xmplpath=%1").replace("%1", oldValue),
        QByteArray("qt_xmplpath=%1/examples").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert( QByteArray("qt_demopath=%1").replace("%1", oldValue),
        QByteArray("qt_demopath=%1/demos").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert(QByteArray("qt_tstspath=%1").replace("%1", oldValue),
        QByteArray("qt_tstspath=%1/tests").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert( QByteArray("qt_hbinpath=%1").replace("%1", oldValue),
        QByteArray("qt_hbinpath=%1/bin").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));
    ...
    replaceHash.insert(QByteArray("qt_hlibpath=%1").replace("%1", oldValue),
        QByteArray("qt_hlibpath=%1/lib").replace("%1/", QByteArray(newQtPath).append(nativeSeperator)));

    return replaceHash;
}

QtPatchOperation::QtPatchOperation(PackageManagerCore *core)
